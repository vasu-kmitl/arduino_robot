//******************************************************
// ROBOT SERIES
// Basic 2-Motor Control using Functions #2
...
void move(char dir) {
  switch(dir){
    case 'S': digitalWrite(M1A, LOW);
              digitalWrite(M1B, LOW);
              digitalWrite(M2A, LOW); 
              digitalWrite(M2B, LOW);
              break;
    case 'F': digitalWrite(M1A, HIGH);
              digitalWrite(M1B, LOW);
              digitalWrite(M2A, HIGH);
              digitalWrite(M2B, LOW);
              break;
    case 'B': digitalWrite(M1A, LOW);
              digitalWrite(M1B, HIGH);
              digitalWrite(M2A, LOW);
              digitalWrite(M2B, HIGH);
              break;
    case 'L': digitalWrite(M1A, LOW);
              digitalWrite(M1B, HIGH);
              digitalWrite(M2A, HIGH);
              digitalWrite(M2B, LOW);
              break;
    case 'R': digitalWrite(M1A, HIGH);
              digitalWrite(M1B, LOW);
              digitalWrite(M2A, LOW);
              digitalWrite(M2B, HIGH);
  }
